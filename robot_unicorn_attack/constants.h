...
#define UNICORN_EXPLOSION_TEXTURES_NUM 15
...
#define UNICORN_EXTENDED_JUMP_POWER 700					// moc wydluzonego skoku jednorozca
...
// platform 4
#define PLATFORM4_WIDTH 1000
#define PLATFORM4_HEIGHT 460

#define PLATFORM4_COLLIDERS_NUM 2

#define MIN_PLATFORM4_Y SCREEN_HEIGHT + 100;
#define MAX_PLATFORM4_Y SCREEN_HEIGHT + 300